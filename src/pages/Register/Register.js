...
export default function Register() {
    ...
    const formik = useFormik({
        ...
        validationSchema: yup.object({
            ...
            matKhau: yup.string().min(6, 'Mật khẩu phải có ít nhất 6 kí tự').required('Mật khẩu không được để trống'),
            email: yup.string().email('Bạn phải nhập đúng định dạng email').required('Email không được để trống'),
            soDt: yup
                .string()
                .matches(/(84|0[3|5|7|8|9])+([0-9]{8})\b/g, 'Bạn phải nhập đúng định dạng sđt')
                    ...
                    <div>
                        ...
                        <div className="mt-8">
                            ...
                            {formik.errors.hoTen && formik.touched.hoTen && (
                                <p className="text-red-500 mt-2">{formik.errors.hoTen}</p>
                            )}
                        </div>
                        <div className="mt-8">
                            <div className="flex justify-between items-center">
                        ...
                        <div className="mt-8">
                            ...
                            {formik.errors.soDt && formik.touched.soDt && (
                                <p className="text-red-500 mt-2">{formik.errors.soDt}</p>
                            )}
                        </div>
                        <div className="mt-10">
                            <button
